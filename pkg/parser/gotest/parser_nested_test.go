...
import (
	...
	"github.com/juanvallejo/origin/tools/junitreport/pkg/api"
	"github.com/juanvallejo/origin/tools/junitreport/pkg/builder/nested"
)
		...
		},
		{
			...
			expectedSuites: &api.TestSuites{
				Suites: []*api.TestSuite{
					...
					{
						Name:       "github.com/juanvallejo/origin/tools/junitreport/pkg/parser/gotest/example",
						NumTests:   19,
						NumFailed:  9,
						Duration:   0.006,
